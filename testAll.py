...
def run_metrics(model, samples = 1000, tests = 1000, size = 0):
    ...
    # models = [urw_metrics]
        ...
        search_size = math.floor(len(dataset.item_ids) / 100)
...
if __name__ == '__main__':
    ...
    model_file = "D:\My Docs/University\Year 4\Individual Project/MovieLens100kRecommender/64_30_0.05_0.01_ua.base.pth"
